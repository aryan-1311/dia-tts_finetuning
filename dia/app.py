...
try:
    ...
    model = Dia.from_local(r"C:\Users\admin\PycharmProjects\dia_finetuning\config.json",
                           r"C:\Users\admin\PycharmProjects\dia_finetuning\checkpoints\ckpt_epoch10.pth")
